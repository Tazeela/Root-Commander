...
pub struct RotateAngleFinishedResponse {
    pub timestamp: u32,
    pub x_coord: i32,
    pub y_coord: i32,
    pub heading: i16,
...
impl RotateAngleFinishedResponse {
    pub fn new(message: Message) -> RotateAngleFinishedResponse {
        RotateAngleFinishedResponse {
