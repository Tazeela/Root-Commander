...
use crate::utils::{
    calculate_angle, calculate_degrees_of_rotation, calculate_distance,
    calculate_radius_and_center, Point,
};
...
impl LinearOrchestrator {
    ...
    async fn draw_arc(
        ...
        self.rotate_to_new_heading(robot, calculate_angle(start, &center) - 90.0)
            .await;
